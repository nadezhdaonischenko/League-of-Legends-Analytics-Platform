...
# ====================================================
# 5: Финальный аналитический отчет
# ====================================================
    ...
    top_10_kda = (
        df_champions
        .sort_values(by="avg_kda", ascending=False)
        .head(10)
    )
    ...
    popular_champ = (
        df_parts["champion_name"]
        .value_counts()
        .head(1)
    )

    print(
        f"Самый популярный чемпион месяца: "
    ...
    top_5_players = (
        df_players
        .sort_values(by="league_points", ascending=False)
        .head(5)
    )
