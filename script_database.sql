...
CREATE TABLE matches (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP -- Время записи матча в базу данных
);
...
CREATE TABLE dashboard_champions_cleaned (
    ...
    wins INTEGER,                                  -- Количество побед этим чемпионом за день
    losses INTEGER,                                -- Количество поражений этим чемпионом за день
